...
public class ApplicationController {
    ...
    public ResponseEntity<?> cancel(@PathVariable Long applicationId) {
        Application application = applicationService.cancelApplication(applicationId);
    ...
    public ResponseEntity<?> getByCampaign(@PathVariable Long campaignId) {
        List<ApplicationResponse> applications = applicationService.getApplicationsByCampaign(campaignId);
